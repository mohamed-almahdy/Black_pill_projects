...
static uint8_t SSD1306_Buffer[SSD1306_WIDTH * SSD1306_HEIGHT / 8];
 ...
 FontDef_t Font_7x10;// 7 x 10 pixels font size structure

 FontDef_t Font_11x18;//11 x 18 pixels font size structure

 FontDef_t Font_16x26;//16 x 26 pixels font size structure
